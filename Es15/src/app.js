...
const validationErrorMiddleware = require('./lib/middleware/validation/index').validationErrorMiddleware;
const initSessionMiddleware = require('./lib/middleware/session');
const { passport } = require('./lib/middleware/passport');
const authRoutes = require('./routes/auth');
const {notFoundMiddleware,initErrorMiddleware} = require('./lib/middleware/error');
